...
<script type="text/javascript">
	...
	function saveBaby(){
 	        ...
 	        if (flag) {  
 	        	var row = $('#datagrid').datagrid('getSelected');
		 	   	 	if (row){
		 	   	 		var id = row.id;
		 	   		 	//$("#recordDateStr").val($("#recordDate").val());
		 	   		 	url = path+"/baby/deleteById?id="+id;
		 	   		 	mesTitle = '删除记录成功';
		 	   		 	$.ajax({
		 	   		 		 type: "POST",
		 	   		 		 async: false,
 	...
 	function showChart(){
 		 var myChart = echarts.init(document.getElementById('babyChart'));
 		 var xdata=[];
 		 var ydata1=[];
 		 var ydata2=[];
 		 var ydata3=[];
...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		...
		<table id="datagrid" title="记录管理" class="easyui-datagrid" fit="true"
			url="<%=basePath%>/baby/getDataGridBaby" toolbar="#toolbar" pagination="true"
			fitColumns="true" singleSelect="true" rownumbers="true"
			border="false" nowrap="false">
			<thead>
				<tr>
					<th field="id" width="100">编号</th>
					<th field="height" width="100">身高</th>
					<th field="weight" width="100">体重</th>
					<th field="head" width="100">头围</th>
		...
		<div id="toolbar">
			<a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-add" plain="true" onclick="addBaby();">新增记录</a> <a
				href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-edit" plain="true" onclick="editBaby();">编辑记录</a>
				 <a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true" onclick="deleteBaby();">删除记录</a>
				 <a href="javascript:void(0);" class="easyui-linkbutton"
		...
		<div id="dlg" class="easyui-dialog"
			...
			<form id="fm" method="post" novalidate>
				<div class="fitem">
					<label>身高(cm):</label> <input name="height" class="easyui-textbox"
						required="true"  validType="float">
				</div>
				<div class="fitem">
					<label>体重(kg):</label> <input name="weight" class="easyui-textbox"
						required="true"  validType="float">
				</div>
				<div class="fitem">
					<label>头围(cm):</label> <input name="head" class="easyui-textbox"
						validType="float">
				</div>
				 <div class="fitem">
		...
		<div id="dlg-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6"
				iconCls="icon-ok" onclick="saveBaby()" style="width:90px">保存</a> <a
				href="javascript:void(0)" class="easyui-linkbutton"
		...
		<div id="chartDia" class="easyui-dialog"
			...
			<div id="babyChart"  style="width:700px;height:400px;"></div>
		</div>
		<!-- 对话框按钮 -->
