...
<script type="text/javascript">
	...
	// 更新记录
 	function editWrong(){
	 	...
	 	if (row){
		 	...
		 	url = path+"/wrong/editWrong?id="+id;
		 	mesTitle = '编辑记录成功';
	 	}else{
	...
	function saveWrong(){
 	        ...
 	        if (flag) {  
 	        	var row = $('#datagrid').datagrid('getSelected');
		 	   	 	if (row){
		 	   	 		var id = row.id;
		 	   		 	//$("#recordDateStr").val($("#recordDate").val());
		 	   		 	url = path+"/wrong/deleteById?id="+id;
		 	   		 	mesTitle = '删除记录成功';
		 	   		 	$.ajax({
		 	   		 		 type: "POST",
		 	   		 		 async: false,
 	...
 	function showChart(){
 		 var myChart = echarts.init(document.getElementById('wrongChart'));
 		 var xdata=[];
 		 var ydata1=[];
 		 var ydata2=[];
 		 var ydata3=[];
...
<body class="easyui-layout" fit="true">
	<div region="center" border="false" style="overflow: hidden;">
		...
		<table id="datagrid" title="记录管理" class="easyui-datagrid"  fit="true"
			url="<%=basePath%>/wrong/getDataGridWrong"  toolbar="#toolbar" pagination="true"
			...
			<thead>
				<tr>
					...
					<th field="frequency" width="100">次数</th>
		...
		<div id="toolbar">
			<input	type="text"  id="keyword" name="keyword"  placeholder="请输入单词或者意思关键字"/>
			 <a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-search"  plain="true"  onclick="searchWrong();">查询</a>
			<!-- <a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-add" plain="true" onclick="addWrong();">新增记录</a> <a
				href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-edit" plain="true" onclick="editWrong();">编辑记录</a> -->
				 <a href="javascript:void(0);" class="easyui-linkbutton"
				iconCls="icon-remove" plain="true" onclick="deleteWrong();">删除记录</a>
				 <a href="javascript:void(0);" class="easyui-linkbutton"
		...
		<div id="dlg-buttons">
			<a href="javascript:void(0)" class="easyui-linkbutton c6"
				iconCls="icon-ok" onclick="saveWrong()" style="width:90px">保存</a> <a
				href="javascript:void(0)" class="easyui-linkbutton"
		...
		<div id="chartDia" class="easyui-dialog"
			...
			<div id="wrongChart"  style="width:700px;height:400px;"></div>
		</div>
		<!-- 对话框按钮 -->
